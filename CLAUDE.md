...
Docker-App (FastAPI + Frontend): aus **einem Satz** ein kompletter Bild-+-Text-Post
(Outline → Cover → Folgeseiten, stilkonsistent, akkurater Text). Referenz für den
Skill `nano-banana-pro`. App-Setup: siehe README.md.
